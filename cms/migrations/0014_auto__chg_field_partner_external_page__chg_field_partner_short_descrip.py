...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Partner.external_page'
        db.alter_column(u'cms_partner', 'external_page', self.gf('django.db.models.fields.URLField')(default='http://example.com', max_length=200))

        # Changing field 'Partner.short_description'
        db.alter_column(u'cms_partner', 'short_description', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Partner.logo'
        db.alter_column(u'cms_partner', 'logo', self.gf('django.db.models.fields.URLField')(default='http://example.com', max_length=200))

        # Changing field 'Partner.external_fallback'
        db.alter_column(u'cms_partner', 'external_fallback', self.gf('django.db.models.fields.URLField')(default='http://example.com', max_length=200))

    def backwards(self, orm):

        # Changing field 'Partner.external_page'
        db.alter_column(u'cms_partner', 'external_page', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Partner.short_description'
        db.alter_column(u'cms_partner', 'short_description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Partner.logo'
        db.alter_column(u'cms_partner', 'logo', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
    ...
    models = {
        ...
        u'cms.partner': {
            ...
            'created_by': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
            ...
            'updated_by': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
