...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'cms_partner', 'external_page', 'partner_website')
        db.rename_column(u'cms_partner', 'external_fallback', 'fallback_website')


    def backwards(self, orm):
        db.rename_column(u'cms_partner', 'partner_website', 'external_page')
        db.rename_column(u'cms_partner', 'fallback_website', 'external_fallback')
