...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Partner.always_featured'
        db.add_column(u'cms_partner', 'always_featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Partner.always_featured'
        db.delete_column(u'cms_partner', 'always_featured')
    ...
    models = {
        ...
        u'cms.partner': {
            ...
            'always_featured': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
