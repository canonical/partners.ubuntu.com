...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cms_partner', 'short_description', self.gf('django.db.models.fields.TextField')(max_length=260, null=True))

    def backwards(self, orm):

        # Changing field 'Partner.short_description'
        db.alter_column(u'cms_partner', 'short_description', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
    ...
    models = {
        ...
        u'cms.partner': {
            ...
            'short_description': ('django.db.models.fields.TextField', [], {'max_length': '260', 'null': 'True', 'blank': 'True'}),
